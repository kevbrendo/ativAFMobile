...
public class InsertDespesaView extends AppCompatActivity {
    ...
    public void inserirDespesa(View view){
        ...
        try {
                ...
                if (dataLocalDate.isAfter(dataAtual)) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sim", (dialog, which) -> {
                                ...
                                long id = dao.addDespesa(despesa);

                                Toast.makeText(this, "Despesa inserida com sucesso com o ID: " + id, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "Erro ao inserir despesa: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
