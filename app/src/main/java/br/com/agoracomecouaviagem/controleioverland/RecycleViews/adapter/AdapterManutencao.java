...
public class AdapterManutencao extends RecyclerView.Adapter<AdapterManutencao.MyViewHolder> {

    private List<Manutencao> lstManutencao;
    private DataTextWatcher dtw = new DataTextWatcher();

    public AdapterManutencao(List<Manutencao> lstManutencao) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.data.setText("Data: " + formatDate(manutencao.getData()));
        holder.valor.setText("Valor R$:" + String.format("%.2f", manutencao.getValor()));
        holder.local.setText("Local: " + manutencao.getLocal());
        holder.categoria.setText(manutencao.getCategoria());
        holder.descricao.setText(manutencao.getDescricao());
