...
public class InsertEstacionamentoView extends AppCompatActivity {

    private Switch switchData;
    private Spinner spinner;
    private EditText data;
    private EditText valor;
    private EditText quantidadeHoras;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quantidadeHoras = findViewById(R.id.editHoras);
    ...
    public void inserirEstacionamento(View view) {
        ...
        try {
                ...
                if (dataLocalDate.isAfter(dataAtual)) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sim", (dialog, which) -> {
                                ...
                                estacionamento.setQuantidadeHoras(Integer.parseInt(quantidadeHoras.getText().toString()));
                                estacionamento.setId_viagem(idViagemAtiva);
                                long id = dao.addEstacionamento(estacionamento);

                                Toast.makeText(this, "Estacionamento inserido com sucesso com o ID: " + id, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "Erro ao inserir estacionamento: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
