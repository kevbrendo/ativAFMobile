...
public class InsertPasseioView extends AppCompatActivity {
    ...
    public void inserirPasseio(View view) {
        ...
        if (stringData.isEmpty() || stringPagamento.isEmpty() || stringLocal.isEmpty() || stringValor.isEmpty() || stringNomePasseio.isEmpty()) {
        ...
        try {
                ...
                if (dataLocalDate.isAfter(dataAtual)) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Sim", (dialog, which) -> {
                                ...
                                long id = dao.addPasseio(passeio);


                                Toast.makeText(this, "Passeio inserido com sucesso com o ID: " + id, Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "Erro ao inserir passeio: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
    }